...
{
	vk->flat_pipeline = vk_create_pipeline_and_shaders(vk, "shaders/flat_vs.spv", "shaders/flat_ps.spv", vk->simple_piepline_layout);
	vk->lit_pipeline = vk_create_pipeline_and_shaders(vk, "shaders/lit_vs.spv", "shaders/lit_ps.spv", vk->simple_piepline_layout);
...
int main(int argc, char **argv)
{
	...
	s_window = SDL_CreateWindow("vk_hlsl",
